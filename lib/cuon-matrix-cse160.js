...
class Vector3 {
    ...
    static cross(other1, other2) {
        ...
        // (a, b, c) x (d, e, f) = (b*f-c*e, -(a*f-c*d), a*e-b*d)
        let [a, b, c] = other1.elements;
        let [d, e, f] = other2.elements;
        
        let v3 = new Vector3([b*f-c*e, -(a*f-c*d), a*e-b*d]); // Modify this line to calculate cross product between other1 and other2.
    ...
    magnitude() {
        // Insert your code here.
        let n1 = this.elements[0];
        let n2 = this.elements[1];
        let n3 = this.elements[2];
        let m = Math.sqrt(n1*n1 + n2*n2 + n3*n3); // Modify this line to calculate this vector's magnitude.
